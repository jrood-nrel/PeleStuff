...
#Cori KNL
JOBS[((IDX++))]="pelec-scaling:debug:knl:${OWD}/PeleC3d.${COMPILER}.mic-knl.MPI.OMP.ex:${OWD}/input-3d:1:8:2:30"; PRE_ARGS[$IDX]="export OMP_NUM_THREADS=4;"; POST_ARGS[$IDX]="amr.probin_file=${OWD}/probin-3d amr.n_cell=128 128 128"
