...
COMPILER=intel
TEST_RUN="TRUE" # Only works for Slurm
...
#Cori KNL
JOBS[((IDX++))]="pelec-scaling:debug:knl:${OWD}/PeleC3d.${COMPILER}.mic-knl.MPI.OMP.ex:${OWD}/input-3d:1:16:30"; PRE_ARGS[$IDX]="export OMP_NUM_THREADS=4;"; POST_ARGS[$IDX]="amr.probin_file=${OWD}/probin-3d amr.n_cell=128 128 128"
...
#Cori Haswell
#JOBS[((IDX++))]="pelec-scaling:debug:haswell:${OWD}/PeleC3d.${COMPILER}.haswell.MPI.ex:${OWD}/input-3d:1:16:30"; PRE_ARGS[$IDX]=""; POST_ARGS[$IDX]="amr.probin_file=${OWD}/probin-3d amr.n_cell=128 128 128"
...
#Peregrine Haswell
#JOBS[((IDX++))]="pelec-scaling:short:haswell:${OWD}/PeleC3d.${COMPILER}.MPI.ex:${OWD}/input-3d:1:12:40"; PRE_ARGS[$IDX]=""; POST_ARGS[$IDX]="amr.probin_file=${OWD}/probin-3d amr.n_cell=128 128 128"
