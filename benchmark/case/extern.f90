...
module extern_probin_module
  ...
  real (kind=dp_t), save, public :: small_massfrac = 1.d-30
  !$acc declare create(small_massfrac)
  real (kind=dp_t), save, public :: react_T_min = 200.d0
  !$acc declare create(react_T_min)
  real (kind=dp_t), save, public :: react_T_max = 5000.d0
  !$acc declare create(react_T_max)
  real (kind=dp_t), save, public :: react_rho_min = 1.e-10
  !$acc declare create(react_rho_min)
  real (kind=dp_t), save, public :: react_rho_max = 1.e10
